    ...
    <div class="dashboard">
      ...
      <aside class="side-stack">
        ...
        <section class="panel">
          ...
          <h3>Fast flight zoom first</h3>
          <p class="card-copy">For moving birds, favor Sony 100-400 f/4.5 or Canon 100-500 before the longest option. Keep 24-105 ready for scale, sky, and reflections.</p>
        </section>
      </aside>
    </div>`;
}
...
function renderGear() {
  ...
  root.innerHTML = `
    <div class="section-title">
      ...
      <p>Start with the Bosque bird kit, then adjust if the same bag must also work in Tanzania. Bosque rewards long reach; Tanzania makes the 70-200mm f/2.8 much more important.</p>
    </div>
    <div class="grid-2">
      ${gearCards
        .map(
...
function renderSources() {
  ...
  root.innerHTML = `
    <div class="section-title">
      <div>
        <p class="eyebrow">Checked June 2-3, 2026</p>
        <h2>Sources</h2>
      </div>
