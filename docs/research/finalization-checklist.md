...
- Preferred date window: December 6-12, 2026, to avoid Festival of the Cranes crowds.
- Alternate date window retained: November 29-December 5, 2026, only if festival programming becomes a goal.
- Lodging party: one room for two adults.
- Lodging bias: Socorro for photography-first logistics; Comfort Inn & Suites Socorro is the current safe/value default from the Dec 6-12 snapshot.
- Marriott Bonvoy: considered via Fairfield by Marriott Inn & Suites Los Lunas, but treated as a loyalty tradeoff rather than the default dawn base.
- Camera system: Sony and Canon branches intentionally retained because the user has not chosen a final system.

## Completion Audit

| Requirement | Current Status | Evidence | What Still Has To Happen |
|---|---|---|---|
| Verify exact map coordinates, parking/pullouts, one-way road notes, and restroom/food/fuel pins | Completed for planning use | `docs/research/map-logistics.md`, `docs/research/photography-spots.md`, `site/app.js` | Field-verify against posted maps and signs on arrival |
| Recheck current refuge rules, closures, road access, fees, visitor-center hours, and water/bird-location conditions closer to travel | Current official rules/access rechecked June 3, 2026 | `docs/research/sources.md`, `docs/research/map-logistics.md`, official FWS Visit Us, Auto Tour, and Rules pages | Repeat close to travel; same-day water and bird-location conditions require refuge staff/posted intel |
| Confirm final trip dates, then update sunrise/sunset times for those exact dates | Decision-gated; two candidate windows documented, sun times updated, and December 6-12 is the current planning bias | `docs/research/itinerary.md`, `docs/research/festival-of-the-cranes.md` | User must formally choose Option A, November 29-December 5, 2026, or Option B, December 6-12, 2026 |
...
These are the only remaining gates for the original list:

| Gate | Why It Cannot Be Completed From Research Alone | Current Best Next Action |
|---|---|---|
| Formal date choice | User has said December 6-12 is likely preferred, but has not formally chosen it as final. | Confirm December 6-12, 2026 or choose the festival-overlap option. |
