...
| Accessible auto-tour photography | The [Auto Tour Loop](https://www.fws.gov/refuge/bosque-del-apache/visit-us/activities/auto-tour) is about 12 miles, with viewing areas and legal pullouts. |
...
- Best peak crane/goose spectacle: late November through December, with early November through late January as the broader high-number period per [FWS species guidance](https://www.fws.gov/refuge/bosque-del-apache/species).
...
Current names, access, and road conditions must be verified on the [FWS Visit Us](https://www.fws.gov/refuge/bosque-del-apache/visit-us), [Auto Tour](https://www.fws.gov/refuge/bosque-del-apache/visit-us/activities/auto-tour), [Rules](https://www.fws.gov/refuge/bosque-del-apache/visit-us/rules-policies), [Trails](https://www.fws.gov/refuge/bosque-del-apache/visit-us/trails), and [Map](https://www.fws.gov/refuge/bosque-del-apache/map) pages before travel. The following locations are planning anchors, not promises that birds will be there on a specific day.
...
Sandhill cranes are the emotional center of Bosque winter photography. They roost in shallow water for safety, feed in fields and wetlands, and often move in family groups or loose flocks. Look for posture changes: birds facing into the wind, calling, stretching, walking with intent, and groups tightening before movement. For takeoff, leave room in front of the bird and do not zoom so tight that the first wingbeat clips the frame. Cornell's [Sandhill Crane life history](https://www.allaboutbirds.org/guide/Sandhill_Crane/lifehistory) is useful background for behavior, habitat, and family groups.

Snow geese are different. A single goose is beautiful, but the flock is the event. They can rise suddenly in dense waves, often triggered by group tension or perceived threat. Your job is to decide before it happens whether the image is a wide white storm, a mid-range pattern, or a tight bird-in-flight shot. White feathers blow out easily in sun, so protect highlights. Cornell's [Snow Goose life history](https://www.allaboutbirds.org/guide/Snow_Goose/lifehistory) helps with flocking and feeding context.

Ross's geese may mix with snow geese. Treat them as an identification and storytelling bonus unless you have a clear species-comparison opportunity. Cornell's [Ross's Goose page](https://www.allaboutbirds.org/guide/Rosss_Goose/lifehistory) helps distinguish the smaller, stubbier goose from Snow Goose.
...
Use recent eBird checklists for pattern detection: which hotspot, what date, what species, and whether the report mentions numbers, behavior, or location detail. Useful starting links include [North Loop](https://ebird.org/hotspot/L1358840), [South Loop](https://ebird.org/hotspot/L876716), and [Macaulay Library location/media search](https://search.macaulaylibrary.org/catalog?searchField=location&q=Bosque%20del%20Apache). The Birding Hub's [Bosque page](https://www.thebirdinghub.com/directory/new-mexico/bosque-del-apache-nwr) exposed eBird-powered recent observations on June 3, 2026, which is helpful as a signal, but treat any third-party current feed as supplemental.
...
This section is grounded first in official FWS rules. As of June 3, 2026, the [FWS Rules and Policies page](https://www.fws.gov/refuge/bosque-del-apache/visit-us/rules-policies) is the authority for Bosque. Key field implications:
...
Audubon's [ethical bird photography guide](https://www.audubon.org/audubons-guide-ethical-bird-photography) is a useful supplement: the welfare of the bird comes before the image. At Bosque, that means using the vehicle as a blind, letting birds feed and rest, keeping your distance, and accepting that some angles are not legally or ethically available.

## Logistics

Bosque del Apache is reached from the Socorro/San Antonio area in central New Mexico. Albuquerque International Sunport is the practical major airport for many travelers; verify current flights and rental cars through [ABQ Sunport](https://www.abqsunport.com/facts-figures/) and the rental-car page.
...
Socorro is the practical photography-first lodging base because it has more hotels, food, fuel, and a reasonable pre-dawn drive. San Antonio is closer but has smaller lodging inventory. Existing project lodging research ranked Comfort Inn & Suites Socorro, Best Western Socorro Hotel & Suites, Holiday Inn Express Socorro, Econo Lodge Inn & Suites, and Casa Blanca B&B as the main options for the Dec. 6-12, 2026 planning window, with all rates requiring final direct recheck. Los Lunas is a Marriott Bonvoy tradeoff, not a dawn-photography base. If accessibility matters, verify current trail, deck, restroom, parking, and room-access details directly before booking or committing to a location plan.
...
- `site/assets/snow-geese-gary-stolz-usfws-1800.jpg`: Snow geese at Bosque del Apache. Use near the overview or blast-off technique section. Credit: Gary Stolz / USFWS, Public Domain.
- `site/assets/sandhill-cranes-ryan-hagerty-usfws-1800.jpg`: Sandhill cranes in shallow refuge water. Use near the crane behavior or seasonality section. Credit: Ryan Hagerty / USFWS, Public Domain.
- `site/assets/snow-geese-flyout-lynne-braden-usfws-1800.jpg`: Snow geese flying over photographers, a useful visual for crowd etiquette and scale. Credit: Lynne Braden / USFWS volunteer, Public Domain.
- FWS Willow Deck image candidate: "View of sandhill cranes from Willow Deck." Use as a practical location/observation-deck figure if added after a final license check.
- Figure callout idea: "Wind plus light decides your position." Diagram a pool with sunrise direction, wind direction, bird landing direction, and legal pullouts.
- Figure callout idea: "The Bosque day." Timeline from pre-dawn setup through blast-off, feeding fields, midday scout, sunset fly-in, and image review.

## Source List

Official and current logistics:

- [USFWS Bosque del Apache Visit Us](https://www.fws.gov/refuge/bosque-del-apache/visit-us)
- [USFWS Auto Tour](https://www.fws.gov/refuge/bosque-del-apache/visit-us/activities/auto-tour)
- [USFWS Rules and Policies](https://www.fws.gov/refuge/bosque-del-apache/visit-us/rules-policies)
- [USFWS Trails](https://www.fws.gov/refuge/bosque-del-apache/visit-us/trails)
- [USFWS Map](https://www.fws.gov/refuge/bosque-del-apache/map)
- [USFWS Species](https://www.fws.gov/refuge/bosque-del-apache/species)
- [USFWS What We Do](https://www.fws.gov/refuge/bosque-del-apache/what-we-do)
- [Friends of Bosque del Apache Festival of the Cranes](https://friendsofbosquedelapache.org/festival/)
- [Cornell Festival of the Cranes listing](https://www.allaboutbirds.org/news/event/festival-of-the-cranes/)
- [Timeanddate Socorro sun data](https://www.timeanddate.com/sun/usa/socorro?month=12&year=2026)
- [National Weather Service Socorro forecast](https://forecast.weather.gov/MapClick.php?lat=34.0485&lon=-106.8934)
- [NM Roads](https://www.nmroads.com/)

Birding, behavior, and scouting:

- [eBird North Loop hotspot](https://ebird.org/hotspot/L1358840)
- [eBird South Loop hotspot](https://ebird.org/hotspot/L876716)
- [The Birding Hub Bosque del Apache NWR](https://www.thebirdinghub.com/directory/new-mexico/bosque-del-apache-nwr)
- [Macaulay Library Bosque del Apache media search](https://search.macaulaylibrary.org/catalog?searchField=location&q=Bosque%20del%20Apache)
